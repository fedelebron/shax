...
def medium_dmediumt(arg0 :: f32[6], 
  ...
  let x0 :: f32[6] = arg0
      ...
      x47 :: f32[2] = reshape [2] x46
      x48 :: f32[2] = arg2
      x49 :: f32[1, 2] = reshape [1,2] x48
      x50 :: f32[2, 2] = pad [(1,0),(0,0)] 0.0 x49
      x51 :: f32[2, 2] = pad [(0,1),(0,0)] 0.0 x49
      x52 :: f32[2, 2] = add x51 x50
      x53 :: f32[2, 2] = negate x52
      x54 :: f32[2, 2] = mul x42 x53
      x55 :: f32[2, 2] = mul x41 x53
      x56 :: f32[2, 2] = mul x29 x52
      x57 :: f32[2, 2] = mul x28 x52
      x58 :: f32[2, 2] = add x56 x54
      x59 :: f32[2, 2] = add x57 x55
      x60 :: f32[2, 2] = mul x14 x59
      x61 :: f32[2, 2] = mul x13 x59
      x62 :: f32[2, 2] = add x61 x58
      x63 :: f32[2, 2] = add x60 x58
      x64 :: f32[1, 2, 2] = reshape [1,2,2] x63
      x65 :: f32[1, 2, 6] = transpose [0,2,1] x11
      x66 :: f32[1, 2, 6] = dot_general [2] [1] [0] [0] x64 x65
      x67 :: f32[1, 6, 2] = transpose [0,2,1] x10
      x68 :: f32[1, 6, 2] = dot_general [2] [1] [0] [0] x67 x64
      x69 :: f32[6, 2] = reshape [6,2] x68
      x70 :: f32[2, 6] = reshape [2,6] x66
      x71 :: f32[2, 6] = transpose [1,0] x69
      x72 :: f32[2, 6] = mul x8 x70
      x73 :: f32[2, 6] = add x72 x71
      x74 :: f32[2, 6] = mul x6 x73
      x75 :: f32[2, 6] = add x74 x73
      x76 :: f32[2, 6] = mul x3 x75
      x77 :: f32[6] = reduce_sum [0] x76
  in [x47, x77, x62]
VJP:
[┌───────────────────┐
 │34.731194  67.46239│
